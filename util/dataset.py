...
def get_physionet_dataset():
    ...
    if not os.path.exists('../data/io/PhysioNetMI'):
        ...
        # print(table)
        print(channels_name)
        table.to_csv("../data/PhysioNetMI/physionetmi_meta.csv", index=False)
        ...
        dataset = CSVFolderDataset(csv_path="../data/PhysioNetMI/physionetmi_meta.csv",
                                read_fn=default_read_fn,
                                io_path='../data/io/PhysioNetMI',
