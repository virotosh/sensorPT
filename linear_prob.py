...
if __name__=="__main__":
    ...
    for sub in sub_indices:#for i in reversed(range(1,195)):
        all_subjects = [i]
        all_datas = []
        train_dataset,valid_dataset,test_dataset = leave_one_user_out_IMWUTdata(sub,data_path,0, target_sample=256*2, agument=True)
